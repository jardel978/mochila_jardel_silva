...
const estudantes = require('./estudantes-export');
...
let cursoCtd = new Curso("CTD", 5, 2, [estudantes.estudante01, estudantes.estudante02]);//chamando a função construtora do curso
cursoCtd.adicionarAlunos(estudante03);
// console.log(cursoCtd.listaEstudantes[2].media());
console.log(cursoCtd.verificarAprovacao(estudantes.estudante02));
